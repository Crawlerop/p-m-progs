...
our %config = (
  ...
  openssldir => "",
  options => "--prefix=/media/wrapper/OS/wserver4/p-m-progs2/srs-server-4.0-b10/trunk/objs/Platform-Linux-5.15.0-GCC11.2.0-SRS4-x86_64/openssl-1.1-fit/_release -DOPENSSL_NO_HEARTBEATS no-asan no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-md2 no-msan no-rc5 no-sctp no-shared no-ssl-trace no-ssl3 no-ssl3-method no-threads no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "x86_64-linux-gnu-thread-multi",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.34.0",
  perlargv => [ "linux-x86_64", "--prefix=/media/wrapper/OS/wserver4/p-m-progs2/srs-server-4.0-b10/trunk/objs/Platform-Linux-5.15.0-GCC11.2.0-SRS4-x86_64/openssl-1.1-fit/_release", "-no-shared", "-no-threads", "-DOPENSSL_NO_HEARTBEATS" ],
  perlenv => {
      "AR" => undef,
      "BUILDFILE" => undef,
      "CC" => undef,
  ...
  prefix => "/media/wrapper/OS/wserver4/p-m-progs2/srs-server-4.0-b10/trunk/objs/Platform-Linux-5.15.0-GCC11.2.0-SRS4-x86_64/openssl-1.1-fit/_release",
  processor => "",
