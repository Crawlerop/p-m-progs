...
private:
    virtual srs_error_t af_padding(ISrsStreamWriter* writer, SrsTsChannel *chan, int16_t pid);
...
public:
    static SrsTsPacket* null_af_packet(SrsTsContext* context, int16_t pid, uint8_t cc);
...
public:
    ...
    // Align TS frames
    virtual srs_error_t align_frames();
public:
