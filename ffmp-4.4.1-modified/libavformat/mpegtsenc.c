...
static const AVOption options[] = {
    ...
    { "mpegts_pmt_start_pid", "Set the first pid of the PMT.",
      OFFSET(pmt_start_pid), AV_OPT_TYPE_INT, { .i64 = 0x0fff }, FIRST_OTHER_PID, LAST_OTHER_PID, ENC },
